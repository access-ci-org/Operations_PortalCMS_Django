...
def system_status_news(request):
    ...
    if request.user.is_authenticated and (
        request.user.has_perm('portal.change_systemstatusnews') or
        request.user.has_perm('portal.can_review_systemstatusnews') or
        request.user.has_perm('portal.can_publish_systemstatusnews')
    ):
    ...
    context = {
        ...
        'page_obj': page_obj,
        'can_review': request.user.has_perm('portal.can_review_systemstatusnews') if request.user.is_authenticated else False,
        'can_publish': request.user.has_perm('portal.can_publish_systemstatusnews') if request.user.is_authenticated else False,
    }
    return render(request, 'portal/infrastructure_news.html', context)
...
def integration_news(request):
    ...
    # Show all news to authenticated users with permissions
    if request.user.is_authenticated and (
        request.user.has_perm('portal.change_integrationnews') or
        request.user.has_perm('portal.can_review_integrationnews') or
        request.user.has_perm('portal.can_publish_integrationnews')
    ):
    ...
    context = {
        ...
        'page_obj': page_obj,
        'can_review': request.user.has_perm('portal.can_review_integrationnews') if request.user.is_authenticated else False,
        'can_publish': request.user.has_perm('portal.can_publish_integrationnews') if request.user.is_authenticated else False,
    }
    return render(request, 'portal/integration_news.html', context)


# News management views with permission checks

@login_required
@permission_required('portal.add_systemstatusnews', login_url=reverse_lazy('portal:unprivileged'))
def add_system_status_news(request):
    """Add new system and infrastructure status news item"""
    can_publish = request.user.is_superuser or request.user.has_perm('portal.can_publish_systemstatusnews')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('portal:system_status_news')
    else:
    ...
    return render(request, 'portal/add_system_status_news.html', context)


@login_required
@permission_required('portal.change_systemstatusnews', login_url=reverse_lazy('portal:unprivileged'))
def update_system_status_news(request, pk):
    ...
    return render(request, 'portal/update_system_status_news.html', context)


@login_required
@permission_required('portal.add_integrationnews', login_url=reverse_lazy('portal:unprivileged'))
def add_integration_news(request):
    """Add new integration news item"""
    can_publish = request.user.is_superuser or request.user.has_perm('portal.can_publish_integrationnews')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            news.save()
            form.save_related_fields(news)
            return redirect('portal:integration_news')
    else:
    ...
    return render(request, 'portal/add_integration_news.html', context)


@login_required
@permission_required('portal.change_integrationnews', login_url=reverse_lazy('portal:unprivileged'))
def update_integration_news(request, pk):
    ...
    return render(request, 'portal/update_integration_news.html', context)
...
def access_allocated_resources(request):
    ...
    return render(request, 'portal/access_allocated.html', context)
...
def access_online_services(request):
    ...
    return render(request, 'portal/access_online_services.html', context)
...
def software_discovery(request):
    ...
    return render(request, 'portal/software_discovery.html', context)
...
def software_detail(request, software_id):
    ...
    return render(request, 'portal/software_detail.html', context)
