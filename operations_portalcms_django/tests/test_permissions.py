...
from portal.signals import sync_cilogon_groups
...
def test_rp_coordinator():
    ...
    has_perm = user.has_perm('portal.coordinator_rp.psc.edu')
...
def test_multiple_roles():
    ...
    tests = [
        ('portal.coordinator_rp.tacc.utexas.edu', 'TACC Coordinator'),
        ('portal.implementer_rp.sdsc.edu', 'SDSC Implementer'),
        ('portal.concierge', 'Concierge'),
        ('portal.coordinator_rp.psc.edu', 'PSC Coordinator (should be False)'),
    ]
...
def test_group_removal():
    ...
    has_coordinator = user.has_perm('portal.coordinator_rp.ncsa.illinois.edu')
    ...
    has_implementer = user.has_perm('portal.implementer_rp.psc.edu')
